...
// Mapping for computed burn values for the 3 lower-arms exercises.
// Keys are the exercise names in lowercase.
final Map<String, Map<String, dynamic>> computedExerciseData = {
  "side wrist pull stretch": { "type": "time", "MET": 1.5 },
...
double computeBurnValue(String exerciseName, double weight, double height, int age, String gender) {
  ...
  // Calories per minute formula: (MET * weight * 3.5) / 200.
...
class _LowerArmsAllexercisesState extends State<LowerArmsAllexercises>
  ...
  // Initializes the stream from AllExercises for lower arms exercises.
  ...
  Future<void> checkAndFetchNeckExercises() async {
    ...
    try {
      ...
      if (neckSnapshot.docs.isEmpty) {
        print("No lower arms exercises found in AllExercises. Fetching from BodyweightExercises...");
