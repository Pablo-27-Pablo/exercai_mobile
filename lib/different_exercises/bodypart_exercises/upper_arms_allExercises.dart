...
// Mapping for computed burn values for the new Upper Arms exercises.
final Map<String, Map<String, dynamic>> computedExerciseData = {
  // Rep-based exercises
  "body-up": { "type": "rep", "MET": 4.0, "repDuration": 3.0 },
  "close-grip push-up": { "type": "rep", "MET": 7.5, "repDuration": 3.0 },
  "diamond push-up": { "type": "rep", "MET": 8.0, "repDuration": 3.0 },
  "reverse dip": { "type": "rep", "MET": 6.5, "repDuration": 3.0 },
  "side push-up": { "type": "rep", "MET": 6.0, "repDuration": 3.0 },
  "triceps dips floor": { "type": "rep", "MET": 7.0, "repDuration": 3.0 },
  "push-up on lower arms": { "type": "rep", "MET": 5.5, "repDuration": 3.0 },
  "bodyweight side lying biceps curl": { "type": "rep", "MET": 5.0, "repDuration": 3.0 },
  "biceps leg concentration curl": { "type": "rep", "MET": 5.5, "repDuration": 3.0 },
  "bodyweight kneeling triceps extension": { "type": "rep", "MET": 5.5, "repDuration": 3.0 },
  "close-grip push-up (on knees)": { "type": "rep", "MET": 6.5, "repDuration": 3.0 },
  "bench dip (knees bent)": { "type": "rep", "MET": 6.0, "repDuration": 3.0 },
  // Time-based exercises
  "overhead triceps stretch": { "type": "time", "MET": 2.0 },
  "triceps stretch": { "type": "time", "MET": 1.8 },
};
...
class UpperArmsAllexercises extends StatefulWidget {
  @override
  _UpperArmsAllexercisesState createState() => _UpperArmsAllexercisesState();
}

class _UpperArmsAllexercisesState extends State<UpperArmsAllexercises>
    with AutomaticKeepAliveClientMixin<UpperArmsAllexercises> {
    ...
    if (_currentUser != null) {
      setState(() {
        _exercisesStream = FirebaseFirestore.instance
            ...
            .where('bodyPart', isEqualTo: 'upper arms')
            .snapshots();
      });
    }
  }
  ...
  Future<void> checkAndFetchNeckExercises() async {
    ...
    try {
      ...
      if (neckSnapshot.docs.isEmpty) {
        print("No upper arms exercises found in AllExercises. Fetching from BodyweightExercises...");
        await fetchExercisesFromFirestoreInBackground();
      } else {
        print("Upper Arms exercises already exist. Using real-time stream.");
      }
    } catch (e) {
      print("Error checking upper arms exercises: $e");
    }
  }
  ...
  Future<void> fetchExercisesFromFirestoreInBackground() async {
    ...
    try {
      ...
      print("Successfully merged upper arms exercises into AllExercises");
    } catch (e) {
        ...
        body: isLoading
          ...
          builder: (context, exercisesSnapshot) {
            ...
            return exercises.isEmpty
                ? Center(
                child: Text("No Upper Arms exercises found. Tap reload if needed.",
