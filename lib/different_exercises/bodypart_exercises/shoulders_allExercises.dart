...
class _ShouldersAllexercisesState extends State<ShouldersAllexercises>
    with AutomaticKeepAliveClientMixin<ShouldersAllexercises> {
  ...
  // Initializes the stream from AllExercises for shoulders exercises.
  ...
  // Check if shoulders exercises exist in AllExercises.
  ...
  Future<void> checkAndFetchNeckExercises() async {
    ...
    try {
      ...
      if (neckSnapshot.docs.isEmpty) {
        print("No shoulders exercises found in AllExercises. Fetching from BodyweightExercises...");
        await fetchExercisesFromFirestoreInBackground();
      } else {
        print("shoulders exercises already exist. Using real-time stream.");
      }
    } catch (e) {
      print("Error checking shoulders exercises: $e");
    }
  }
  ...
  Future<void> _initializeData() async {
    await fetchUserData();
    // Check if shoulders exercises exist; if not, fetch and merge them.
        ...
        body: isLoading
          ...
          builder: (context, exercisesSnapshot) {
            ...
            return exercises.isEmpty
                ? Center(
                child: Text("No shoulders exercises found. Tap reload if needed.",
