...
class _ChestAllexercisesState extends State<ChestAllexercises>
  ...
  // Initializes the stream from AllExercises for chest exercises.
  ...
  // Check if chest exercises exist in AllExercises.
  ...
  Future<void> checkAndFetchNeckExercises() async {
    ...
    try {
      ...
      if (neckSnapshot.docs.isEmpty) {
        print("No chest exercises found in AllExercises. Fetching from BodyweightExercises...");
        await fetchExercisesFromFirestoreInBackground();
      } else {
        print("chest exercises already exist. Using real-time stream.");
      }
    } catch (e) {
      print("Error checking chest exercises: $e");
    }
  }
  ...
  Future<void> _initializeData() async {
    await fetchUserData();
    // Check if chest exercises exist; if not, fetch and merge them.
