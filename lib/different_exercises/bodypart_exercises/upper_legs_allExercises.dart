...
class _UpperLegsAllexercisesState extends State<UpperLegsAllexercises>
    with AutomaticKeepAliveClientMixin<UpperLegsAllexercises> {
  ...
  Future<void> checkAndFetchNeckExercises() async {
    ...
    try {
      ...
      if (neckSnapshot.docs.isEmpty) {
        print("No upper legs exercises found in AllExercises. Fetching from BodyweightExercises...");
        await fetchExercisesFromFirestoreInBackground();
      } else {
        print("upper legs exercises already exist. Using real-time stream.");
      }
    } catch (e) {
      print("Error checking upper legs exercises: $e");
    }
  }
