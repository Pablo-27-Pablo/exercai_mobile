...
// Mapping for computed burn values for the two neck exercises.
// Both are time based.
...
class NeckAllexercises extends StatefulWidget {
  @override
  _NeckAllexercisesState createState() => _NeckAllexercisesState();
}

class _NeckAllexercisesState extends State<NeckAllexercises>
    with AutomaticKeepAliveClientMixin<NeckAllexercises> {
    ...
    try {
      ...
      for (var doc in snapshot.docs) {
        ...
        if (computedExerciseData.containsKey(exerciseName.toLowerCase())) {
          ...
          // Since both neck exercises are time based, update burnCalperSec.
      ...
      print("Successfully merged neck exercises into AllExercises");
    } catch (e) {
