...
class _BackAllexercisesState extends State<BackAllexercises>
    with AutomaticKeepAliveClientMixin<BackAllexercises> {
  ...
  Future<void> fetchExercisesFromFirestoreInBackground() async {
    ...
    try {
      ...
      print("Successfully merged back exercises into AllExercises");
    } catch (e) {
        ...
        body: isLoading
          ...
          builder: (context, exercisesSnapshot) {
            ...
            return exercises.isEmpty
                ? Center(
                child: Text("No Back exercises found. Tap reload if needed.",
